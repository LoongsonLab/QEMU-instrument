...
{
    INS_InsertIfCall(ins, IPOINT_BEFORE, (AFUNPTR)ins_count, IARG_END);
    INS_InsertThenCall(ins,IPOINT_BEFORE, (AFUNPTR)show_ins, IARG_UINT64, ins->pc, IARG_UINT64, ins->opcode, IARG_END);
}
